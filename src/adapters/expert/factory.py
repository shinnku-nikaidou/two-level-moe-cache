...
class AdapterFactory:
    ...
    @classmethod
    def create_adapter(cls, model_type: ModelType, checkpoint_path: str) -> ExpertAdapter:
        """
    ...
    @classmethod
    def register_adapter(cls, model_type: ModelType, adapter_class: Type[ExpertAdapter]) -> None:
        """
